...
# CodeArtifact auth via BuildKit secret (CI or scripts/docker-build.sh).
...
LABEL org.opencontainers.image.source="https://github.com/mentor-forge/mentorhub_discovery_spa"

ENV API_HOST=mentorhub_discovery_api
ENV API_PORT=8397
